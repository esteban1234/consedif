...
<ul>
  ...
  <li class="select"><a href="nosotros.php">NOSOTROS</a></li>
  <li><a href="servicios.php">SERVICIOS</a></li>
  <li><a href="contacto.php">CONTACTO</a></li>
</ul>
</nav>

<h1 style="color: #F9921A; text-align: center; margin-top: 3%;">LA EMPRESA</h1>
<hr>

<h2 style="text-align: center; margin-top: 3%;">Constructora CONSEDIF</h2>

<p class="texton"> Somos una empresa dedicada a la industria de la construcción,desarrollando tanto proyectos de vivienda como proyectos de educación, institucionales, comercio y recreo.</p>

<figure class="imgbanner">
	<img src="../img/bannern.jpg" alt="" class="img-responsive">
</figure>
...
<div class="contenporque">
	<h1 style="color:  #1c2833; text-align: center; margin-top: 3%;">¿PORQUE ESCOGERNOS?</h1>
<hr>
